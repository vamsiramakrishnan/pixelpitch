...
export const AnnoHighlighterMarkVersion = '1.0.0';

export interface AnnoHighlighterMarkProps {
  bbox: Bbox;
  color?: Color;
  opacity?: number;
}

export default function AnnoHighlighterMark(props: AnnoHighlighterMarkProps): ReactNode {
  ...
  return (
    <div data-recipe-id="anno.highlighter-mark" data-recipe-version="1.0.0">
      <SurfaceShapeFill {...({ bbox: props.bbox } as unknown as ComponentProps<typeof SurfaceShapeFill>)} />
    </div>
  );
}

export function annoHighlighterMarkToIR(
  props: AnnoHighlighterMarkProps,
  ...
  return {
    kind: 'group',
    recipeId: 'anno.highlighter-mark',
    bbox: { ...props.bbox },
    zOrder: 0,
    metadata: {
      role: 'anno.highlighter-mark',
      axis: 'anno',
