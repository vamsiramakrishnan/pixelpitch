...
- Local packaging orchestration for packaged Pixelpitch artifacts.
...
- Consuming sidecar/process/path primitives from `@pixelpitch/sidecar-proto`, `@pixelpitch/sidecar`, and `@pixelpitch/platform`.
