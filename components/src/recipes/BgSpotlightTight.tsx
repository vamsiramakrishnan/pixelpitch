...
export const BgSpotlightTightVersion = '1.0.0';

export interface BgSpotlightTightProps {
  bbox: Bbox;
  cx?: number;
  cy?: number;
  color?: Color;
...
export default function BgSpotlightTight(props: BgSpotlightTightProps): ReactNode {
...
export function bgSpotlightTightToIR(
  props: BgSpotlightTightProps,
  ...
  return {
    kind: 'group',
    recipeId: 'bg.spotlight-tight',
    bbox: { ...props.bbox },
    zOrder: 0,
    metadata: {
      role: 'bg.spotlight-tight',
      axis: 'bg',
