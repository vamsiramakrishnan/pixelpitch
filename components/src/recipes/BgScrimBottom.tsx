...
export interface BgScrimBottomProps {
  bbox: Bbox;
  color?: Color;
  opacity?: number;
}

export default function BgScrimBottom(props: BgScrimBottomProps): ReactNode {
...
export function bgScrimBottomToIR(
  props: BgScrimBottomProps,
