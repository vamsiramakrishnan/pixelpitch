...
export const DataBarSetHVersion = '1.0.0';

export interface DataBarSetHProps {
  bbox: Bbox;
  bars: unknown[];
  max?: number;
}

export default function DataBarSetH(props: DataBarSetHProps): ReactNode {
...
export function dataBarSetHToIR(
  props: DataBarSetHProps,
