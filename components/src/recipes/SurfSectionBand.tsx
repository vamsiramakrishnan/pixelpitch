...
export const SurfSectionBandVersion = '1.0.0';

export interface SurfSectionBandProps {
  bbox: Bbox;
  fill?: Fill;
}

export default function SurfSectionBand(props: SurfSectionBandProps): ReactNode {
...
export function surfSectionBandToIR(
  props: SurfSectionBandProps,
  ...
  return {
    kind: 'group',
    recipeId: 'surf.section-band',
    bbox: { ...props.bbox },
    zOrder: 0,
    metadata: {
      role: 'surf.section-band',
      axis: 'surf',
