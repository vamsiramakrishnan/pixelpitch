...
export default function DataDeltaBadge(props: DataDeltaBadgeProps): ReactNode {
  ...
  return (
    <div data-recipe-id="data.delta-badge" data-recipe-version="1.0.0">
      <_PrimitiveDataDeltaBadge {...({ bbox: props.bbox, value: props.value, direction: props.direction, size: props.size } as unknown as ComponentProps<typeof _PrimitiveDataDeltaBadge>)} />
    </div>
  );
}
...
export function dataDeltaBadgeToIR(
  ...
  const primitiveArgs = { bbox: props.bbox, value: props.value, direction: props.direction, size: props.size } as unknown as Parameters<typeof _primitive_dataDeltaBadgeToIR>[0];
