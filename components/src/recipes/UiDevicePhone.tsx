...
export default function UiDevicePhone(props: UiDevicePhoneProps): ReactNode {
  ...
  return (
    <div data-recipe-id="ui.device-phone" data-recipe-version="1.0.0">
      <ChromeDeviceFrame {...({ bbox: props.bbox, screenshotSrc: props.screenshotSrc, notch: props.notch, device: 'phone' } as unknown as ComponentProps<typeof ChromeDeviceFrame>)} />
    </div>
  );
}
...
export function uiDevicePhoneToIR(
  ...
  const primitiveArgs = { bbox: props.bbox, screenshotSrc: props.screenshotSrc, notch: props.notch, device: 'phone' } as unknown as Parameters<typeof chromeDeviceFrameToIR>[0];
