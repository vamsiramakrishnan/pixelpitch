...
export default function DataDataTable(props: DataDataTableProps): ReactNode {
  ...
  return (
    <div data-recipe-id="data.data-table" data-recipe-version="1.0.0">
      <DataTable {...({ bbox: props.bbox, headers: props.headers, rows: props.rows, zebra: props.zebra ?? true, align: props.align } as unknown as ComponentProps<typeof DataTable>)} />
    </div>
  );
}
...
export function dataDataTableToIR(
  ...
  const primitiveArgs = { bbox: props.bbox, headers: props.headers, rows: props.rows, zebra: props.zebra ?? true, align: props.align } as unknown as Parameters<typeof dataTableToIR>[0];
