...
export default function BgDiagonal(props: BgDiagonalProps): ReactNode {
  ...
  return (
    <div data-recipe-id="bg.diagonal" data-recipe-version="1.0.0">
      <SurfacePatternTile {...({ bbox: props.bbox, angleDeg: props.angleDeg, pattern: 'diagonal' } as unknown as ComponentProps<typeof SurfacePatternTile>)} />
    </div>
  );
}
...
export function bgDiagonalToIR(
  ...
  const primitiveArgs = { bbox: props.bbox, angleDeg: props.angleDeg, pattern: 'diagonal' } as unknown as Parameters<typeof surfacePatternTileToIR>[0];
