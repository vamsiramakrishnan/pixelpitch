...
export default function TypeEyebrowRuled(props: TypeEyebrowRuledProps): ReactNode {
  ...
  return (
    <div data-recipe-id="type.eyebrow-ruled" data-recipe-version="1.0.0">
      <SlotEyebrow {...({ bbox: props.bbox, text: props.label, color: props.color ?? tokens.palette("accent") } as unknown as ComponentProps<typeof SlotEyebrow>)} />
    </div>
  );
}
...
export function typeEyebrowRuledToIR(
  ...
  const primitiveArgs = { bbox: props.bbox, text: props.label, color: props.color ?? tokens.palette("accent") } as unknown as Parameters<typeof slotEyebrowToIR>[0];
