...
export const DecBulletDotVersion = '1.0.0';

export interface DecBulletDotProps {
  bbox: Bbox;
  color?: Color;
  sizePx?: number;
}

export default function DecBulletDot(props: DecBulletDotProps): ReactNode {
  // Codegen renders Tier-B recipes as a stable, recipe-id-stamped wrapper
  // around the underlying primitive. Visual fidelity comes from the
  // primitive; this wrapper exists so the IR carries the atom id.
  return (
    <div data-recipe-id="dec.bullet-dot" data-recipe-version="1.0.0">
      <SurfaceShapeFill {...({ bbox: props.bbox } as unknown as ComponentProps<typeof SurfaceShapeFill>)} />
    </div>
  );
}

export function decBulletDotToIR(
  props: DecBulletDotProps,
