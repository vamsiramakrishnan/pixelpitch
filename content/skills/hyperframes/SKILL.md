...
## Pixelpitch integration (load-bearing for this surface)

When this skill runs inside Pixelpitch (i.e. `$PIXELPITCH_PROJECT_DIR` is set), the
...
**Do NOT** call `pixelpitch media generate --model hyperframes-html` — that
