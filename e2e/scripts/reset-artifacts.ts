...
const targets = [
  path.join(e2eDir, '.pixelpitch-data'),
...
await mkdir(path.join(e2eDir, '.pixelpitch-data'), { recursive: true });
...
const projectsRoot = path.join(e2eDir, '.pixelpitch-data', 'projects');
try {
