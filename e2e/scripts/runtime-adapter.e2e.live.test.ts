...
const liveTimeoutMs = Number(process.env.PIXELPITCH_RUNTIME_LIVE_TIMEOUT_MS || 180_000);
const requestedRuntimeIds = parseRuntimeIds(process.env.PIXELPITCH_E2E_RUNTIMES);
const maxRuntimeCount = 8;
const marker = 'PIXELPITCH_RUNTIME_ADAPTER_LIVE_OK';
...
test.before(async () => {
  ...
  process.env.PIXELPITCH_DATA_DIR = dataDir;
