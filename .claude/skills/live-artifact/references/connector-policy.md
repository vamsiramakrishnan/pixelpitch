...
- Tool endpoints require the injected `PIXELPITCH_TOOL_TOKEN`; do not invent or pass `projectId`.
...
```json
{
  ...
  "input": { "owner": "pixelpitch", "repo": "pixelpitch" },
  "connector": {
