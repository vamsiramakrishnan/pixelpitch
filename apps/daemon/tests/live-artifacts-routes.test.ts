...
import { ConnectorServiceError, connectorService } from '../src/connectors/service.js';
import { CHAT_TOOL_ENDPOINTS, CHAT_TOOL_OPERATIONS, toolTokenRegistry } from '../src/tool-tokens.js';

const here = path.dirname(fileURLToPath(import.meta.url));
const projectRoot = path.resolve(here, '../../..');
const serverRuntimeDataRoot = process.env.PIXELPITCH_DATA_DIR
  ? path.resolve(projectRoot, process.env.PIXELPITCH_DATA_DIR)
  : path.join(projectRoot, '.pixelpitch');
