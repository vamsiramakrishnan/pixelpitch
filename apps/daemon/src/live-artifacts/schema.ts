// Runtime validation lives in the daemon; DTO ownership lives in contracts.
import type {
  BoundedJsonObject,
  BoundedJsonValue,
  LiveArtifact,
  LiveArtifactConnectorApprovalPolicy,
  LiveArtifactCreateInput,
  LiveArtifactDocument,
  LiveArtifactOutputTransform,
  LiveArtifactPreview,
  LiveArtifactProvenance,
  LiveArtifactProvenanceSource,
  LiveArtifactRefreshConnectorMetadata,
  LiveArtifactRefreshErrorRecord,
  LiveArtifactRefreshLogEntry,
  LiveArtifactRefreshSourceMetadata,
  LiveArtifactRefreshSourceType,
  LiveArtifactRefreshStepStatus,
  LiveArtifactSource,
