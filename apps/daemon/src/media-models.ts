...
export const MEDIA_PROVIDERS = [
  ...
  { id: 'nanobanana', label: 'Nano Banana', hint: 'Gemini API or Vertex AI image generation', integrated: true, defaultBaseUrl: 'https://generativelanguage.googleapis.com', supportsCustomModel: true },
