...
// /api/media/config; the daemon persists them to .pixelpitch/media-config.json
...
// folder altogether (`PIXELPITCH_OPENAI_API_KEY=… node daemon/cli.js`).
//
...
const ENV_KEYS = {
  ...
  openai: [
    'PIXELPITCH_OPENAI_API_KEY',
    'OPENAI_API_KEY',
    'AZURE_API_KEY',
    'AZURE_OPENAI_API_KEY',
  ],
  volcengine: ['PIXELPITCH_VOLCENGINE_API_KEY', 'ARK_API_KEY', 'VOLCENGINE_API_KEY'],
  // PIXELPITCH_GROK_API_KEY first (the project-reserved override, same shape as
  ...
  google: ['PIXELPITCH_GOOGLE_API_KEY', 'GOOGLE_API_KEY', 'GEMINI_API_KEY'],
  kling: ['PIXELPITCH_KLING_API_KEY', 'KLING_API_KEY'],
  midjourney: ['PIXELPITCH_MIDJOURNEY_API_KEY'],
  minimax: ['PIXELPITCH_MINIMAX_API_KEY', 'MINIMAX_API_KEY'],
  suno: ['PIXELPITCH_SUNO_API_KEY'],
  udio: ['PIXELPITCH_UDIO_API_KEY'],
  elevenlabs: ['PIXELPITCH_ELEVENLABS_API_KEY', 'ELEVENLABS_API_KEY'],
