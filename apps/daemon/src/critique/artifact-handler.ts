 ...
 * floor: an instance with `PIXELPITCH_CRITIQUE_PARSER_MAX_BLOCK_BYTES` raised above
...
export function handleCritiqueArtifact(
  ...
  // PIXELPITCH_CRITIQUE_PARSER_MAX_BLOCK_BYTES below 4 MiB would still stream
