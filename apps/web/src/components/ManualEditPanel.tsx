...
function manualEditT(key: string, vars?: Record<string, string | number>): string {
  const labels: Record<string, string> = {
    ...
    'manualEdit.empty': 'Select an editable element in the preview.',
    'manualEdit.fontSize': 'Font size',
    'manualEdit.fullSource': 'Full source',
    'manualEdit.href': 'Link URL',
    'manualEdit.imageUrl': 'Image URL',
    'manualEdit.invalidAttributes': 'Attributes must be valid JSON.',
    ...
    'manualEdit.selectedHtml': 'Selected HTML',
