...
export const zhCN: Dict = {
  ...
  'fileViewer.vercelTokenGetLink': '获取 Google Cloud project ID',
  'fileViewer.vercelTokenPlaceholder': '粘贴你的 Google Cloud project ID',
  'fileViewer.vercelTokenReuseHint': '将使用已保存的 token。输入新 token 可替换。',
  'fileViewer.vercelTokenRequired': '请先输入并保存 Google Cloud project ID。',
  ...
  'pet.title': '宠物',
  'pet.tabBuiltIn': '内置',
  'pet.tabBuiltInHint': 'Pixelpitch 内置的精选宠物 — 一键领养。',
  ...
  'pet.codexBundled': '内置',
  'pet.codexBundledTitle': 'Pixelpitch 内置宠物，无需下载。',
