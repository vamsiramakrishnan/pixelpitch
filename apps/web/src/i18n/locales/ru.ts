...
export const ru: Dict = {
  ...
  'settings.welcomeTitle': 'Настройка Pixelpitch',
  ...
  'fileViewer.deployModalSubtitle':
    'Deploy this HTML artifact as a public Cloud Run service using gcloud on this machine.',
  'fileViewer.vercelToken': 'Google Cloud project ID',
  'fileViewer.vercelTokenGetLink': 'Get Google Cloud project ID',
  'fileViewer.vercelTokenPlaceholder': 'Paste your Google Cloud project ID',
  'fileViewer.vercelTokenReuseHint':
    'Saved token will be used. Enter a new token to replace it.',
  'fileViewer.vercelTokenRequired': 'Enter and save a Google Cloud project ID first.',
  ...
  'fileViewer.deployLinkProtected':
    'Your site deployed, but Cloud Run is requiring authentication for this preview link. Disable Deployment Protection or use a custom domain.',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте Pixelpitch — выберите и забирайте.',
  ...
  'pet.subtitle': 'Заведите маленького спутника, который парит над вашим воркспейсом.',
  ...
  'pet.codexBundledTitle': 'Поставляется с Pixelpitch — загрузка не нужна.',
