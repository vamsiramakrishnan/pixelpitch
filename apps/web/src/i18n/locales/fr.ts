...
export const fr: Dict = {
  ...
  'settings.welcomeTitle': 'Configurer Pixelpitch',
  ...
  'pet.tabBuiltInHint': 'Compagnons fournis avec Pixelpitch — choisissez-en un et adoptez-le.',
  ...
  'pet.codexBundledTitle': 'Livré avec Pixelpitch — aucun téléchargement nécessaire.',
