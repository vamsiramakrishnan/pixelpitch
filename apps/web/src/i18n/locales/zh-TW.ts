...
export const zhTW: Dict = {
  ...
  'settings.welcomeTitle': '初始化 Pixelpitch',
  ...
  'fileViewer.vercelTokenGetLink': '取得 Google Cloud project ID',
  'fileViewer.vercelTokenPlaceholder': '貼上你的 Google Cloud project ID',
  'fileViewer.vercelTokenReuseHint': '將使用已儲存的 token。輸入新 token 可替換。',
  'fileViewer.vercelTokenRequired': '請先輸入並儲存 Google Cloud project ID。',
  ...
  'pet.title': '寵物',
  'pet.tabBuiltIn': '內建',
  'pet.tabBuiltInHint': 'Pixelpitch 內建的精選寵物 — 一鍵領養。',
  ...
  'pet.codexBundled': '內建',
  'pet.codexBundledTitle': 'Pixelpitch 內建寵物，無需下載。',
