...
export const en: Dict = {
  ...
  'settings.welcomeTitle': 'Set up Pixelpitch',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Pixelpitch — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Pixelpitch — no download needed.',
