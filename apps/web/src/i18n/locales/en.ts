...
export const en: Dict = {
  ...
  'app.brand': 'Google Cloud APAC AI Practice',
  'app.brandPill': 'Field Lab',
  'app.brandSubtitle': 'AI solution design studio',
  'app.welcomeLoading': 'Loading workspace…',

  'settings.welcomeKicker': 'Welcome',
  'settings.welcomeTitle': 'Set up the AI Practice Studio',
  'settings.welcomeSubtitle':
    "Pick how this workstation should route generation runs. You can change this any time from the Settings button in the top bar.",
  'settings.kicker': 'Settings',
  'settings.title': 'Execution and model routing',
  'settings.subtitle':
    'Choose a local code-agent CLI or bring your own API endpoint. Credentials stay local to this browser and workstation.',
  ...
  'entry.tabDesigns': 'Workspaces',
  'entry.tabExamples': 'Playbooks',
  ...
  'newproj.titlePrototype': 'New app prototype',
  'newproj.titleDeck': 'New executive deck',
  ...
  'newproj.importClaudeZip': 'Import design ZIP',
  'newproj.importClaudeZipTitle': 'Import a design .zip export',
  'newproj.importingClaudeZip': 'Importing…',
  'newproj.privacyFooter': 'Workspace files stay local unless you publish them.',
  ...
  'fileViewer.deployToVercel': 'Deploy to Cloud Run',
  'fileViewer.redeployToVercel': 'Redeploy',
  'fileViewer.deployingToVercel': 'Deploying to Cloud Run…',
  'fileViewer.preparingPublicLink': 'Preparing public link…',
  'fileViewer.copyDeployLink': 'Copy link',
  'fileViewer.deployModalTitle': 'Deploy to Cloud Run',
  'fileViewer.deployModalSubtitle':
    'Uses the gcloud CLI on this machine to build and publish this HTML artifact as a Cloud Run service.',
  'fileViewer.vercelToken': 'Project ID',
  'fileViewer.vercelTokenGetLink': 'Allow public unauthenticated access',
  'fileViewer.vercelTokenPlaceholder': 'my-gcp-project',
  'fileViewer.vercelTokenReuseHint':
    'Saved Cloud Run settings are ready for the next deploy.',
  'fileViewer.vercelTokenRequired': 'Enter and save a project, region, and service name first.',
  'fileViewer.vercelTeamId': 'Region',
  'fileViewer.vercelTeamSlug': 'Service name',
  'fileViewer.optional': 'Optional',
  'fileViewer.vercelPreviewOnly':
    'Requires gcloud to be installed and authenticated with Cloud Run and Cloud Build permissions.',
  'fileViewer.savingConfig': 'Saving…',
  'fileViewer.deployConfigSaveFailed': 'Could not save Cloud Run settings.',
  'fileViewer.deployFailed': 'Deploy failed. Check Cloud Run settings and try again.',
  ...
  'fileViewer.deployLinkDelayed':
    'Your site is deployed. Cloud Run is still preparing the public link.',
  'fileViewer.deployLinkProtectedLabel': 'Cloud Run auth required',
  'fileViewer.deployLinkProtected':
    'Your site deployed, but Cloud Run is requiring authentication. Enable unauthenticated access or update IAM.',
  ...
  'assistant.producedFiles': 'Generated Files',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with the studio — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with the studio — no download needed.',
