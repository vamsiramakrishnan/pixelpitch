...
export const de: Dict = {
  ...
  'settings.welcomeTitle': 'Pixelpitch einrichten',
  ...
  'pet.tabBuiltInHint': 'Mit Pixelpitch gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.codexBundledTitle': 'Wird mit Pixelpitch ausgeliefert — kein Download nötig.',
