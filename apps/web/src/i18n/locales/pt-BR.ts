...
export const ptBR: Dict = {
  ...
  'settings.welcomeTitle': 'Configure o Pixelpitch',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no Pixelpitch — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o Pixelpitch — sem download.',
