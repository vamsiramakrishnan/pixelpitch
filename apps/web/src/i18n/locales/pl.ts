...
export const pl: Dict = {
  ...
  'settings.welcomeTitle': 'Skonfiguruj Pixelpitch',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do Pixelpitch — wybierz jednego i adoptuj.',
  ...
  'pet.codexBundledTitle': 'Dostarczany z Pixelpitch — bez pobierania.',
