...
export const fa: Dict = {
  ...
  'settings.welcomeTitle': 'Pixelpitch را راه‌اندازی کنید',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Pixelpitch — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه Pixelpitch ارائه می‌شود — نیازی به دانلود نیست.',
