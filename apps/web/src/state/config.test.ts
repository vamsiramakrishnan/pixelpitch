...
describe('loadConfig', () => {
  it('migrates legacy OpenAI-compatible API configs to an explicit apiProtocol', () => {
    ...
    store.set('pixelpitch:config', JSON.stringify(legacyConfig));
  ...
  it('does not migrate daemon-mode configs', () => {
    ...
    store.set('pixelpitch:config', JSON.stringify(daemonConfig));
  ...
  it('does not overwrite an already explicit apiProtocol', () => {
    ...
    store.set('pixelpitch:config', JSON.stringify(explicitConfig));
  ...
  it('returns defaults for malformed localStorage JSON', () => {
    store.set('pixelpitch:config', '{broken-json');
