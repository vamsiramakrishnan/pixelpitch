...
~/.claude/skills/
    magazine-web-ppt → ~/.pixelpitch/skills/magazine-web-ppt
~/.codex/skills/
    magazine-web-ppt → ~/.pixelpitch/skills/magazine-web-ppt
```
...
3. `packages/contracts/src/prompts/system.ts` injects the concatenated craft body **between** the active DESIGN.md and the skill body. Brand tokens in DESIGN.md win on conflict; craft rules cover everything DESIGN.md does not override.
...
# → clones into ~/.pixelpitch/skills/magazine-web-ppt
...
5. Daemon dispatches to active agent (Claude Code) with:
   ...
   - cwd: `./.pixelpitch/artifacts/2026-04-24-pitch-deck/`
