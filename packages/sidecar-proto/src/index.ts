...
export const SIDECAR_ENV = Object.freeze({
  BASE: "PIXELPITCH_SIDECAR_BASE",
  DAEMON_PORT: "PIXELPITCH_PORT",
  IPC_BASE: "PIXELPITCH_SIDECAR_IPC_BASE",
  IPC_PATH: "PIXELPITCH_SIDECAR_IPC_PATH",
  NAMESPACE: "PIXELPITCH_SIDECAR_NAMESPACE",
  SOURCE: "PIXELPITCH_SIDECAR_SOURCE",
  TOOLS_DEV_PARENT_PID: "PIXELPITCH_TOOLS_DEV_PARENT_PID",
  WEB_DIST_DIR: "PIXELPITCH_WEB_DIST_DIR",
  WEB_PORT: "PIXELPITCH_WEB_PORT",
  WEB_TSCONFIG_PATH: "PIXELPITCH_WEB_TSCONFIG_PATH",
} as const);
...
export const SIDECAR_DEFAULTS = Object.freeze({
  host: "127.0.0.1",
  ipcBase: "/tmp/pixelpitch/ipc",
  namespace: "default",
  projectTmpDirName: ".tmp",
  windowsPipePrefix: "pixelpitch",
} as const);
...
export type PixelpitchSidecarContract = {
...
} as const satisfies PixelpitchSidecarContract);
