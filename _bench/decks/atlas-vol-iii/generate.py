...
Run:
    uv run python _bench/decks/atlas-vol-iii/generate.py
    uv run slidify check _bench/decks/atlas-vol-iii/01-cover.html
    uv run slidify convert _bench/decks/atlas-vol-iii/ _bench/decks/atlas-vol-iii/out/atlas-iii.pptx
"""
