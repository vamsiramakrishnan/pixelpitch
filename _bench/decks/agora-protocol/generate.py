...
TITLES_BY_SLUG = {
    "agora-protocol": [
        "cover", "thesis", "flow", "premise", "execution", "object",
        "liquidity", "system", "tension", "trust", "method", "routing",
        "latency", "signal", "field-note", "security", "resolution",
        "scale", "close",
    ],
    "crt-archive": [
        "boot", "cover", "index", "premise", "daemon", "object", "patch",
        "system", "tension", "trace", "method", "module", "cache",
        "signal", "field-note", "watch", "export", "resolution", "close",
        "end",
    ],
    "field-notes-quarterly": [
        "cover", "atlas", "premise", "courtyard", "object", "material",
        "system", "studio", "tension", "method", "plate", "margins",
        "signal", "essay", "field-note", "fieldwork", "resolution",
        "close",
    ],
}

TITLES = TITLES_BY_SLUG.get(SLUG, [
